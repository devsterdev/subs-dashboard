      ...
      <div className="p-6 pt-0 flex flex-col items-center flex-grow -mt-12 relative z-10">
        ...
        <div className="text-center mt-4 w-full">
          ...
          <div className="flex flex-wrap justify-center gap-2 mb-6">
            <span className="text-xs font-bold border border-black px-2 py-0.5 rounded-md bg-white">#DSA</span>
            <span className="text-xs font-bold border border-black px-2 py-0.5 rounded-md bg-white">#C++</span>
            <span className="text-xs font-bold border border-black px-2 py-0.5 rounded-md bg-white">#WebDev</span>
          </div>
        </div>
